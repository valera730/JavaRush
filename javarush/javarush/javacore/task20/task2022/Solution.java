...
public class Solution implements Serializable, AutoCloseable {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Solution solution = new Solution("c:\\file.txt");
        solution.writeObject("Hello, world!!\r\n");
        ObjectOutputStream oos= new ObjectOutputStream(new FileOutputStream("c:\\file.obj"));
        oos.writeObject(solution);

        ObjectInputStream ois = new ObjectInputStream((new FileInputStream("c:\\file.obj")));
        Solution solution2 = (Solution) ois.readObject();
        solution2.writeObject("Hello, world, again!");
    }
}